...
const SupplierModal = ({ visible, onClose, onSelect }) => {
  ...
  const handleSearch = async () => {
    ...
    setIsLoading(true)
    try {
      const response = await http.get(`/suppliers/?query=${searchQuery}`)
  ...
  return (
    <CModal visible={visible} onClose={onClose} size="lg">
      <CModalHeader>
        <CModalTitle className="text-secondary">Pesquisar Fornecedor</CModalTitle>
      </CModalHeader>
      <CModalBody>
